...
@class expenseDocumentTile;
@protocol AccordionViewDelegate <NSObject>
@optional
- (void)accordion:(expenseDocumentTile *)accordion didChangeSelection:(NSIndexSet *)selection;
@end

@interface expenseDocumentTile : UIView <UIScrollViewDelegate,headerprotocol> {
