...
@class loanDocumentTile;
@protocol AccordionViewDelegate <NSObject>
@optional
- (void)accordion:(loanDocumentTile *)accordion didChangeSelection:(NSIndexSet *)selection;
@end

@interface loanDocumentTile : UIView <UIScrollViewDelegate,headerprotocol> {
