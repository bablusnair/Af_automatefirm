...
#define insertTimesettingurl @"rest/time_rule_response_api/insert_time"
#define getallTimerulesurl @"rest/time_rule_response_api/get_time_data/"
#define getselectedTimerulesurl @"rest/time_rule_response_api/time_edit"
#define updateTimeRuleUrl @"rest/time_rule_response_api/time_update_details"
#define deleteTimeRuleUrl @"rest/time_rule_response_api/time_delete/"
...
#define myUrl = [nss]
#define createNewShiftUrl @"rest/shift_rule_api/add_shift"
#define getAllShiftRules @"rest/shift_rule_api/shift_view_all/"
#define getSelectedShiftRule @"rest/shift_rule_api/get_shift_data_by_id/"
#define updateShiftRuleUrl @"rest/shift_rule_api/update_shift"
#define deleteShiftRuleUrl @"rest/shift_rule_api/del_shift/"
...
#define deleteteWeekRule @"rest/week_rule_list_api/del_week_rule/"
...
#define designationURL @"rest/week_rule_list_api/get_include_designation"
...
#define includeDesignationUrl @"rest/include_designation_api"
...
#define includeDesignationUrl3 @"rest/get_employee_details_api/desig_list/"

//---------------------------------------Leave Settings Url-------------------------------------

#define viewAllLeavesUrl @"rest/leave_api/leave_view_all/"

#define individualLeaveViewUrl @"rest/leave_api/get_leave_data_by_id/"

#define individualLeaveConditionViewUrl @"rest/leave_api/get_conditions_by_id/"

#define updateLeaveUrl @"rest/leave_api/update_leave_condition"
#define finalUpdateUrl @"rest/leave_api/update_leave_details"
#define deleteLeaveConditionUrl @"rest/leave_api/del_leave_condition/"
#define deleteLeaveRuleUrl @"rest/leave_api/del_leave_rule/"

#define saveLeaveCondition @"rest/leave_api/new_leave_rule_save"
//update_leave_condition"
...
#define leaveAbbrivationurl @"rest/loan_api/leave_abbreviation_list/"


//---------------------------------------loan-service--------------------------------------

#define creatingnewloanurl @"rest/loan_api/insert_loan_rule"

#define secondtimecreatingnewloanurl @"rest/loan_api/insert_loan_condition"

#define loanmaindonebuttonserviceurl @"rest/loan_api/final_loan_rule_save"

#define viewAlloanlistUrl @"rest/loan_api/loan_rule_list/"

#define deleteloanTileurl @"rest/loan_api/delete_loan_condition/"


#define updationofindividualloanrules @"rest/loan_api/loan_rule_details/"

#define updationofloanrulesurl @"rest/loan_api/update_loan_condition"

#define deleteloanRulesurl @"rest/loan_api/delete_loan_rule/"

#define individualtileruleurl @"rest/loan_api/loan_condition_details"
...
#define viewAdvanceViewUrl @"rest/advancerule_api/advance_view/"
#define viewTilesUrl @"rest/advancerule_api/advance_condition_list/"
#define individualAdvanceUrl @"rest/advancerule_api/advance_condition_by_id/"
#define updateAdvanceCondition @"rest/advancerule_api/update_advance_condition"
#define createadvance @"rest/advancerule_api/new_advance_condition_save"
#define deleteadvanceCondtion @"settings/advance_rule/del_advance_condition/?"

//------------------------------------------payrule-------------------------------------------
 //online pay url
#define viewAllPay @"rest/payroll_api/payrol_list/"
#define createNewPay @"rest/payroll_api/insert_payroll_rule"
#define deletepay @"rest/payroll_api/del_payroll/"
#define individualDisplay @"rest/payroll_api/view_details/"
#define updatepay @"rest/payroll_api/update_pay_roll"
...
#define ViewAllExpenseUrl @"rest/re_imbursement_api/re_imbursment_all_list/"
#define individualExpenseViewUrl @"rest/re_imbursement_api/get_re_imbursment_by_id/"
#define expenseCreateUrl @"rest/re_imbursement_api/re_imbursement_save"
#define saveExpenseConditionUrl @"rest/re_imbursement_api/condition_save"
...
#define viewAllOvertimeUrl @"rest/overtime_api/view_overtime_list/"
#define createOvertimeRuleUrl @"rest/overtime_api/insert_overtime"
#define individualOvertimeViewUrl @"rest/overtime_api/get_overtime_details"
#define updateOvertimeUrl @"rest/overtime_api/update_overtime"
#define deleteOvertimeUrl @"rest/overtime_api/del_overtime/"

//-----------------------------------------Income tax-------------------------------------

#define createtaxUrl @"rest/income_tax_api/update"

#define displayincomtaxUrl @"rest/income_tax_api/get_incometax_details/"

//------------------------------------Earnings Rule...Online---------------------------------
#define createerningrule @"rest/earnings_api/insert_earnings_rule"
#define updateErningUrl @"rest/earnings_api/insert_earnings_condition"
...
#define deductCreteUrl @"rest/deduction_api/insert_deduction_details"
#define viewAlldedction @"rest/deduction_api/deduction_list/"
#define updateDeductionUrl @"rest/deduction_api/insert_deduction_condition_details"
#define finaldeductionDone @"rest/deduction_api/update_final_deduction_details"
#define viewdeductionRuleCondition @"rest/deduction_api/deduction_edit_details/"
#define individualConditionViewUrl @"rest/deduction_api/deduction_condition_edit_details/"
#define deleteDeductionRuleUrl @"rest/deduction_api/delete_deduction_rule/"
#define deleteDeductiontileUrl @"rest/deduction_api/delete_deduction_condition/"
...
#define documentationListingservice @"http://192.168.1.20/af1.0/index.php/staffing/documentation/document_list"

//add new document folder

#define addnewdocumentfolder @"http://192.168.1.20/af1.0/index.php/documentation/documents/insert_custom_folder"

//delete a document in employee individual

#define deletedDocumentemployeeindividualsurl @"http://192.168.1.20/af1.0/index.php/staffing/emp_documents_details/delete_emp_documents/"

//delete a document/orgroupdocumentsin documentationfrontscreen

#define deletedDocumentinsdocumentationFrontscreen @"http://192.168.1.20/af1.0/index.php/documentation/documents/update_doc/"

//deletedocumentmainFolderurl

#define deltedMaindocumentFolderdocuments @"http://192.168.1.20/af1.0/index.php/documentation/documents/delete_cfolder/"

//add documents to custom folder

#define customfolderDocumentsaddedUrl @"http://192.168.1.20/af1.0/index.php/staffing/emp_documents_details/upload_custom_documents/"

//move or copy documents

#define moveorcopydocumentsUrl @"http://192.168.1.20/af1.0/index.php/documentation/documents/update_doc/"

//filteremployeedocumentsin frontscreen

#define filterEmployeeDocumentsinFrontscreen @"http://192.168.1.20/af1.0/index.php/documentation/documents/emp_doc_filter"

//documentRenamein document front screen

#define documentRenameindocumentationFrontscreen @"http://192.168.1.20/af1.0/index.php/documentation/documents/update_doc/"

//Detailed Pdfviewer in documentation front screen

#define pdfviewerindocumentation @"http://192.168.1.20/af1.0/index.php/documentation/documents/view_Doc"

//documentEmail

#define sendEmailDocumentationfrontscreen @"http://192.168.1.20/af1.0/index.php/documentation/documents/send_mail"

//printDocument

#define printDocumentationinfrontscreen @"http://192.168.1.20/af1.0/index.php/documentation/documents/print_doc"


//size of the document

#define sizedeterminationdocument @"http://192.168.1.20/af1.0/index.php/documentation/documents/get_doc_size"
...
#define listallPaperworkRuleURL @"rest/paperwork_api/rule_view_all/"
#define individualProtocolViewUrl @"rest/paperwork_api/get_rule_edit_details/"

#define saveProtocolURL @"rest/paperwork_api/insert_protocol"
#define updateProtocolURL @"rest/paperwork_api/update_protocol"
#define savePaperworkRuleURL @"rest/paperwork_api/final_rule_save"
#define viewIndividualProtocolViewURL @"rest/paperwork_api/get_protocol_edit_details/"
#define deletePaperworkProtocolURL @"rest/paperwork_api/delete_protocol/"

#define saveCustomPaperworkURL @"rest/customer_document_api/custom_rule_create"
#define viewCustomPaperworkURL @"rest/customer_document_api/custom_rule_edit_details/"
#define updateCustomPaperworkURL @"rest/customer_document_api/update_custom_rule"

#define deleteCustomPaperworkRuleURL @"http://192.168.1.35/af1.0/index.php/settings/custom_document/delete_custom_rule/"
 ...
 //   [request addValue:@"123456" forHTTPHeaderField:@"apikey"];
    ...
    NSURLSessionDataTask *postDataTask = [session dataTaskWithRequest:request completionHandler:^(NSData *data, NSURLResponse *response, NSError *error) {
        ...
        if ([httpResponse statusCode] == 201) {
            ...
            NSMutableArray *duplicateArray = [json objectForKey:@"message"];
           
           if (duplicateArray.count==1) {
               
            [self.mydelegate showalerviewcontroller:[NSString stringWithFormat:@"%@ Already Exists",[duplicateArray objectAtIndex:0]]];
           }
           else if (duplicateArray.count==2)
           {
               
                [self.mydelegate showalerviewcontroller:[NSString stringWithFormat:@"%@ and %@ are Already Exists",[duplicateArray objectAtIndex:0],[duplicateArray objectAtIndex:1]]];
           }
           else if (duplicateArray.count==3)
           {
               
               [self.mydelegate showalerviewcontroller:[NSString stringWithFormat:@"%@ and %@ and %@ are Already Exists",[duplicateArray objectAtIndex:0],[duplicateArray objectAtIndex:1],[duplicateArray objectAtIndex:2]]];
           }
        }
        else
        {
...
#pragma mark Reset Password and Resend mail
//resetpassword
...
-(void)ResetpasswordSubmissionscreenUsername:(NSString *)username oldpassword:(NSString *)oldpassword  newpassword:(NSString *)newpassword userid:(NSString *)userId
{
    ...
    NSString *urlString=[NSString stringWithFormat:@"%@%@",subdomainURL,resetpasswordforsignup];
    ...
    NSDictionary *mapData = [[NSDictionary alloc] initWithObjectsAndKeys:username,@"username",oldpassword,@"old_password",newpassword,@"password",userId,@"userid",nil];
    ...
    NSURLSessionDataTask *postDataTask = [session dataTaskWithRequest:request completionHandler:^(NSData *data, NSURLResponse *response, NSError *error) {
        ...
        if ([httpResponse statusCode] == 201) {
            ...
            if ([self.mydelegate respondsToSelector:@selector(resetpasswordserviceResponse:)]&&(self.mydelegate!=NULL))
            {
                
                [self.mydelegate resetpasswordserviceResponse:json];
...
-(void)resendmailinsignUpScreen:(NSString *)userId
{
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
    NSString *urlString=[NSString stringWithFormat:@"%@%@%@",subdomainURL,resendmailUrl,userId];
    NSMutableURLRequest *request = [[NSMutableURLRequest alloc] init];
    [request setURL:[NSURL URLWithString:urlString]];
    [request setHTTPMethod:@"GET"];
    ...
    [[session dataTaskWithRequest:request completionHandler:^(NSData *data, NSURLResponse *response, NSError *error) {
        ...
        if ([httpResponse statusCode] == 200) {
            ...
            if ([self.mydelegate respondsToSelector:@selector(resendmail:)]&&(self.mydelegate!=NULL))
            {
                
                [self.mydelegate resendmail:json];
...
//    [dataTask resume];
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
    NSString *urlString=[NSString stringWithFormat:@"%@%@/%@",subdomainURL,getselectedTimerulesurl,ruleid];
...
//    [dataTask resume];
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
    NSString *urlString=[NSString stringWithFormat:@"%@%@%@",subdomainURL,deleteTimeRuleUrl,rid];
...
//    [postDataTask resume];
    ...
    NSURLSessionDataTask *postDataTask = [session dataTaskWithRequest:request completionHandler:^(NSData *data, NSURLResponse *response, NSError *error) {
        ...
        else if ([httpResponse statusCode]==501)
        {
            if ([self.mydelegate respondsToSelector:@selector(showalerviewcontroller:)]&&(self.mydelegate!=NULL))
            {
                [self.mydelegate showalerviewcontroller:@"Shift Rule Name/ Abbreviation Already Exists"];
            }
        }
        else if ([httpResponse statusCode]==500)
        {
...
//    [dataTask resume];
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
    NSString *urlString=[NSString stringWithFormat:@"%@%@%@",subdomainURL,getAllShiftRules,officeID];
...
//    [dataTask resume];
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
    NSString *urlString=[NSString stringWithFormat:@"%@%@%@",subdomainURL,getSelectedShiftRule,ruleid];
...
//    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
//    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
//    NSString *urlString=[NSString stringWithFormat:@"%@%@",subdomainURL,updateShiftRuleUrl];
//    NSURL *url = [NSURL URLWithString:urlString];
//    NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:url
//                                                           cachePolicy:NSURLRequestUseProtocolCachePolicy
//                                                       timeoutInterval:60.0];
...
//    [dataTask resume];
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
    NSString *urlString=[NSString stringWithFormat:@"%@%@%@",subdomainURL,deleteShiftRuleUrl,rid];
    NSMutableURLRequest *request = [[NSMutableURLRequest alloc] init];
    [request setURL:[NSURL URLWithString:urlString]];
    [request setHTTPMethod:@"DELETE"];
    [request setValue:[[NSUserDefaults standardUserDefaults]objectForKey:@"api_key"] forHTTPHeaderField:@"apikey"];
...
//        NSURLSession *session = [NSURLSession sharedSession];
//        NSString *urlString=[NSString stringWithFormat:@"%@%@/%@/%@/%@",subdomainURL,designationURL,officeId,ruleID,ruleType];
//        NSURLSessionDataTask *dataTask = [session dataTaskWithURL:[NSURL URLWithString:urlString] completionHandler:^(NSData *data, NSURLResponse *response, NSError *error) {
//            
//            
//            
...
{
//    NSURLSession *session = [NSURLSession sharedSession];//
//    NSString *urlString=[NSString stringWithFormat:@"%@%@/%@/%@/%@/%@",subdomainURL,includeDesignationUrl,ruleType,ruleID,tileID,officeID];
//    NSURLSessionDataTask *dataTask = [session dataTaskWithURL:[NSURL URLWithString:urlString] completionHandler:^(NSData *data, NSURLResponse *response, NSError *error) {
//        
//        
//        
...
//    [dataTask resume];
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
    NSString *urlString=[NSString stringWithFormat:@"%@%@%@/%@/%@/%@/%@",subdomainURL,includeDesignationUrl3,officeID,ruleType,ruleID,tileID,actionFlag];
...
{
//    NSURLSession *session = [NSURLSession sharedSession];//
//    NSString *urlString=[NSString stringWithFormat:@"%@oid=%@&&rule_id=%@&&tile_id=%@&&progress_id=%@&&type=%@",assigntoSpecificEmployeeURL,officeID,ruleID,conditionID,actionFlow,type];
//    NSURLSessionDataTask *dataTask = [session dataTaskWithURL:[NSURL URLWithString:urlString] completionHandler:^(NSData *data, NSURLResponse *response, NSError *error) {
//        
//        
//        
...
//    [dataTask resume];
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
     NSString *urlString=[NSString stringWithFormat:@"%@%@%@/%@/%@/%@/%@",subdomainURL,assigntoSpecificEmployeeURL,officeID,ruleID,conditionID,actionFlow,type];
...
//    [dataTask resume];
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
    NSString *urlString=[NSString stringWithFormat:@"%@%@%@",subdomainURL,viewAllLeavesUrl,officeId];
...
//    [dataTask resume];
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
    NSString *urlString=[NSString stringWithFormat:@"%@%@%@",subdomainURL,individualLeaveViewUrl,leaveID];
...
//    [dataTask resume];
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
    NSString *urlString=[NSString stringWithFormat:@"%@%@%@",subdomainURL,individualLeaveConditionViewUrl,conditionID];
...
//    [postDataTask resume];
    ...
    NSURLSessionDataTask *postDataTask = [session dataTaskWithRequest:request completionHandler:^(NSData *data, NSURLResponse *response, NSError *error) {
        ...
        else if ([httpResponse statusCode]==501)
        {
            if ([self.mydelegate respondsToSelector:@selector(showalerviewcontroller:)]&&(self.mydelegate!=NULL))
            {
                [self.mydelegate showalerviewcontroller:@"Leave Rule Name/ Abbreviation Already Exists"];
            }
        }
        else if ([httpResponse statusCode]==500)
        {
...
//    [postDataTask resume];
    ...
    NSURLSessionDataTask *postDataTask = [session dataTaskWithRequest:request completionHandler:^(NSData *data, NSURLResponse *response, NSError *error) {
        ...
        if ([httpResponse statusCode] == 201)
        {
            ...
            app.ruleID=[NSString stringWithFormat:@"%@",[json objectForKey:@"rule_id"]];
            [app.conditionIDArray replaceObjectAtIndex:app.selectedRow withObject:[NSString stringWithFormat:@"%@",[json objectForKey:@"condition_id"]]];
...
//    [dataTask resume];
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
    NSString *urlString=[NSString stringWithFormat:@"%@%@%@/%@",subdomainURL,deleteLeaveConditionUrl,conditionID,rule_id];
...
//    [dataTask resume];
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
    NSString *urlString=[NSString stringWithFormat:@"%@%@%@",subdomainURL,deleteLeaveRuleUrl,leaveID];
...
//    [dataTask resume];
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
    NSString *urlString=[NSString stringWithFormat:@"%@%@%@",subdomainURL,leaveAbbrivationurl,officeid];
...
//        [postDataTask resume];
       ...
       NSURLSessionDataTask *postDataTask = [session dataTaskWithRequest:request completionHandler:^(NSData *data, NSURLResponse *response, NSError *error) {
           ...
           else if ([httpResponse statusCode]==501)
           {
               if ([self.mydelegate respondsToSelector:@selector(showalerviewcontroller:)]&&(self.mydelegate!=NULL))
               {
                   [self.mydelegate showalerviewcontroller:@"Loan Rule Name/ Abbreviation Already Exists"];
               }
           }
           else if ([httpResponse statusCode]==500)
           {
...
//    [postDataTask resume];
    ...
    NSURLSessionDataTask *postDataTask = [session dataTaskWithRequest:request completionHandler:^(NSData *data, NSURLResponse *response, NSError *error) {
        ...
        if ([httpResponse statusCode] == 201)
        {
            ...
            if ([self.mydelegate respondsToSelector:@selector(donesavedGotresponse:)]&&(self.mydelegate!=NULL))
            {
                [self.mydelegate donesavedGotresponse:json];
            }
        }
        else if ([httpResponse statusCode]==501)
        {
...
//    [dataTask resume];
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
    NSString *urlString=[NSString stringWithFormat:@"%@%@%@",subdomainURL,viewAlloanlistUrl,officeid];
...
//    [dataTask resume];
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
    NSString *urlString=[NSString stringWithFormat:@"%@%@%@/%@/%@",subdomainURL,deleteloanTileurl,tileid,loanruleid,officeid];
    ...
    [[session dataTaskWithRequest:request completionHandler:^(NSData *data, NSURLResponse *response, NSError *error) {
        ...
        if ([httpResponse statusCode] == 201) {
            ...
            if ([self.mydelegate respondsToSelector:@selector(deleteloantileid:)]&&(self.mydelegate!=NULL))
            {
                [self.mydelegate deleteloantileid:json];
            }
        }
...
//    [dataTask resume];
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
     NSString *urlString=[NSString stringWithFormat:@"%@%@%@/%@",subdomainURL,updationofindividualloanrules,officeid,loanruleid];
...
//    [dataTask resume];
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
    NSString *urlString=[NSString stringWithFormat:@"%@%@%@",subdomainURL,deleteloanRulesurl,loanid];
...
//    [dataTask resume];
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
    NSString *urlString=[NSString stringWithFormat:@"%@%@/%@/%@",subdomainURL,individualtileruleurl,loanid,tileid];
...
//    [postDataTask resume];
    ...
    NSURLSessionDataTask *postDataTask = [session dataTaskWithRequest:request completionHandler:^(NSData *data, NSURLResponse *response, NSError *error) {
        ...
        else if ([httpResponse statusCode]==501)
        {
            if ([self.mydelegate respondsToSelector:@selector(showalerviewcontroller:)]&&(self.mydelegate!=NULL))
            {
                [self.mydelegate showalerviewcontroller:@"Advance Rule Name/ Abbreviation Already Exists"];
            }
        }
        else if ([httpResponse statusCode]==500)
        {
...
//    [dataTask resume];
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
    NSString *urlString=[NSString stringWithFormat:@"%@%@%@",subdomainURL,viewAdvanceViewUrl,officeid];
...
//    [dataTask resume];
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
    NSString *urlString=[NSString stringWithFormat:@"%@%@%@",subdomainURL,viewTilesUrl,ruleid];
...
//    [dataTask resume];
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
    NSString *urlString=[NSString stringWithFormat:@"%@%@%@",subdomainURL,individualAdvanceUrl,condtionId];
...
//    [dataTask resume];
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
    NSString *urlString=[NSString stringWithFormat:@"%@%@%@",subdomainURL,viewAllPay,officeId];
...
//    [postDataTask resume];
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
    NSString *urlString=[NSString stringWithFormat:@"%@%@",subdomainURL,createNewPay];
    NSURL *url = [NSURL URLWithString:urlString];
    NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:url
                                                           cachePolicy:NSURLRequestUseProtocolCachePolicy
                                                       timeoutInterval:60.0];
    ...
    NSURLSessionDataTask *postDataTask = [session dataTaskWithRequest:request completionHandler:^(NSData *data, NSURLResponse *response, NSError *error) {
        ...
        else if ([httpResponse statusCode]==501)
        {
            if ([self.mydelegate respondsToSelector:@selector(showalerviewcontroller:)]&&(self.mydelegate!=NULL))
            {
                [self.mydelegate showalerviewcontroller:@"Pay Rule Name/ Abbreviation Already Exists"];
            }
        }
        else if ([httpResponse statusCode]==500)
        {
...
//    [postDataTask resume];
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
    NSString *urlString=[NSString stringWithFormat:@"%@%@",subdomainURL,updatepay];
    NSURL *url = [NSURL URLWithString:urlString];
    NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:url
                                                           cachePolicy:NSURLRequestUseProtocolCachePolicy
                                                       timeoutInterval:60.0];
...
//[dataTask resume];
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
    NSString *urlString=[NSString stringWithFormat:@"%@%@%@",subdomainURL,deletepay,rulrid];
...
//    [dataTask resume];
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
    NSString *urlString=[NSString stringWithFormat:@"%@%@%@",subdomainURL,individualDisplay,payrule_id];
...
//    [dataTask resume];
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
    NSString *urlString=[NSString stringWithFormat:@"%@%@%@",subdomainURL,ViewAllExpenseUrl,office_id];
...
//    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
//    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
//    NSString *urlString=[NSString stringWithFormat:@"%@%@",subdomainURL,expenseCreateUrl];
//    NSURL *url = [NSURL URLWithString:urlString];
//    NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:url
//                                                           cachePolicy:NSURLRequestUseProtocolCachePolicy
//                                                       timeoutInterval:60.0];
...
//    [postDataTask resume];
    ...
    NSURLSessionDataTask *postDataTask = [session dataTaskWithRequest:request completionHandler:^(NSData *data, NSURLResponse *response, NSError *error) {
        ...
        if ([httpResponse statusCode] == 201)
        {
            ...
            NSLog(@"%@",json);
            app=(AppDelegate *)[[UIApplication sharedApplication]delegate];
            app.ruleID=[json objectForKey:@"expen_id"];
        }
        else if ([httpResponse statusCode]==501)
        {
            if ([self.mydelegate respondsToSelector:@selector(showalerviewcontroller:)]&&(self.mydelegate!=NULL))
...
//    [dataTask resume];
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
    NSString *urlString=[NSString stringWithFormat:@"%@%@%@",subdomainURL,individualExpenseViewUrl,expense_id];
...
//    [postDataTask resume];
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
    NSString *urlString=[NSString stringWithFormat:@"%@%@",subdomainURL,saveExpenseConditionUrl];
    NSURL *url = [NSURL URLWithString:urlString];
    NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:url
                                                           cachePolicy:NSURLRequestUseProtocolCachePolicy
                                                       timeoutInterval:60.0];
    ...
    NSURLSessionDataTask *postDataTask = [session dataTaskWithRequest:request completionHandler:^(NSData *data, NSURLResponse *response, NSError *error) {
        ...
        if ([httpResponse statusCode] == 201)
        {
            ...
            app=(AppDelegate *)[[UIApplication sharedApplication]delegate];
            app.ruleID=[json objectForKey:@"rule_id"];
            [app.conditionIDArray replaceObjectAtIndex:app.selectedRow withObject:[json objectForKey:@"condition_id"]];
        }
        else if ([httpResponse statusCode]==501)
        {
            if ([self.mydelegate respondsToSelector:@selector(showalerviewcontroller:)]&&(self.mydelegate!=NULL))
            {
                [self.mydelegate showalerviewcontroller:@"Expense Reimbursement Name/ Abbreviation Already Exists"];
            }
        }
        else if ([httpResponse statusCode]==500)
        {
...
//    [dataTask resume];
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
    NSString *urlString=[NSString stringWithFormat:@"%@%@expen_id=%@&con_id=%@",subdomainURL,expenseConditionViewUrl,expense_id,condition_id];
...
//    [dataTask resume];
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
    NSString *urlString=[NSString stringWithFormat:@"%@%@con_id=%@",subdomainURL,deleteExpenseConditionUrl,condition_id];
...
//    [dataTask resume];
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
    NSString *urlString=[NSString stringWithFormat:@"%@%@expen_id=%@",subdomainURL,deleteExpenseRuleUrl,expense_id];
...
//    [dataTask resume];
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
    NSString *urlString=[NSString stringWithFormat:@"%@%@%@",subdomainURL,viewAllOvertimeUrl,officeId];
...
//    [postDataTask resume];
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
    NSString *urlString=[NSString stringWithFormat:@"%@%@",subdomainURL,createOvertimeRuleUrl];
    NSURL *url = [NSURL URLWithString:urlString];
    NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:url
                                                           cachePolicy:NSURLRequestUseProtocolCachePolicy
                                                       timeoutInterval:60.0];
    ...
    NSURLSessionDataTask *postDataTask = [session dataTaskWithRequest:request completionHandler:^(NSData *data, NSURLResponse *response, NSError *error) {
        ...
        else if ([httpResponse statusCode]==501)
        {
            if ([self.mydelegate respondsToSelector:@selector(showalerviewcontroller:)]&&(self.mydelegate!=NULL))
            {
                [self.mydelegate showalerviewcontroller:@"Overtime Rule Name/ Abbreviation Already Exists"];
            }
        }
        else if ([httpResponse statusCode]==500)
        {
...
//    [postDataTask resume];
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
    NSString *urlString=[NSString stringWithFormat:@"%@%@",subdomainURL,updateOvertimeUrl];
    NSURL *url = [NSURL URLWithString:urlString];
    NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:url
                                                           cachePolicy:NSURLRequestUseProtocolCachePolicy
                                                       timeoutInterval:60.0];
...
//    [dataTask resume];
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
    NSString *urlString=[NSString stringWithFormat:@"%@%@/%@/%@",subdomainURL,individualOvertimeViewUrl,overtimeID,officeID];
...
//    [dataTask resume];
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
    NSString *urlString=[NSString stringWithFormat:@"%@%@%@",subdomainURL,deleteOvertimeUrl,overtimeID];
...
//    [postDataTask resume];
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
    NSString *urlString=[NSString stringWithFormat:@"%@%@",subdomainURL,createtaxUrl];
    NSURL *url = [NSURL URLWithString:urlString];
    NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:url
                                                           cachePolicy:NSURLRequestUseProtocolCachePolicy
                                                       timeoutInterval:60.0];
...
//    [dataTask resume];
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
    NSString *urlString=[NSString stringWithFormat:@"%@%@%@",subdomainURL,displayincomtaxUrl,officeid];
...
//    [dataTask resume];
    ...
    [[session dataTaskWithRequest:request completionHandler:^(NSData *data, NSURLResponse *response, NSError *error) {
        ...
        if ([httpResponse statusCode] == 200) {
            ...
            if ([self.mydelegate respondsToSelector:@selector(employeelistingService:)]&&(self.mydelegate!=NULL))
            {
                [self.mydelegate employeelistingService:json];
            }
        }
        else if ([httpResponse statusCode]==500)
        {
...
//    [dataTask resume];
    ...
    [[session dataTaskWithRequest:request completionHandler:^(NSData *data, NSURLResponse *response, NSError *error) {
        ...
        if ([httpResponse statusCode] == 200) {
            ...
            if ([self.mydelegate respondsToSelector:@selector(allEmployeeFilterResponse:)]&&(self.mydelegate!=NULL))
            {
                [self.mydelegate allEmployeeFilterResponse:json];
            }
        }
        else if ([httpResponse statusCode]==500)
        {
...
//    [postDataTask resume];
    ...
    NSURLSessionDataTask *postDataTask = [session dataTaskWithRequest:request completionHandler:^(NSData *data, NSURLResponse *response, NSError *error) {
        ...
        if ([httpResponse statusCode] == 200)
        {
            ...
            if ([self.mydelegate respondsToSelector:@selector(filterigemployeelistingService:)]&&(self.mydelegate!=NULL))
            {
                [self.mydelegate filterigemployeelistingService:json];
            }
        }
        else if ([httpResponse statusCode]==501)
        {
...
//    [dataTask resume];
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
    NSString *urlString=[NSString stringWithFormat:@"%@%@%@/%@/%@/%@",subdomainURL,listingEmpAccordingtoTypeUrl,officeID,type,ruleID,tileID];
...
//    [postDataTask resume];
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
    NSString *urlString=[NSString stringWithFormat:@"%@%@",subdomainURL,filterEmpPopUrl];
    NSURL *url = [NSURL URLWithString:urlString];
    NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:url
                                                           cachePolicy:NSURLRequestUseProtocolCachePolicy
                                                       timeoutInterval:60.0];
...
-(void)listingAllPaperworkRule:(NSString *)type :(NSString *)officeID
{
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
    NSString *urlString=[NSString stringWithFormat:@"%@%@%@/%@",subdomainURL,listallPaperworkRuleURL,officeID,type];
...
-(void)individualProtocolRuleView:(NSString *)officeID :(NSString *)ruleID :(NSString *)type
{
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
    NSString *urlString=[NSString stringWithFormat:@"%@%@%@/%@/%@",subdomainURL,individualProtocolViewUrl,officeID,ruleID,type];
...
-(void)saveIndividualProtocol:(id)protocolDict
{
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
    NSString *urlString=[NSString stringWithFormat:@"%@%@",subdomainURL,saveProtocolURL];
    NSURL *url = [NSURL URLWithString:urlString];
    NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:url
                                                           cachePolicy:NSURLRequestUseProtocolCachePolicy
                                                       timeoutInterval:60.0];
...
//    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
//    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
//    NSString *urlString=[NSString stringWithFormat:@"%@",updateProtocolURL];
//    NSURL *url = [NSURL URLWithString:urlString];
//    NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:url
//                                                           cachePolicy:NSURLRequestUseProtocolCachePolicy
//                                                       timeoutInterval:60.0];
...
//    [postDataTask resume];
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
    NSString *urlString=[NSString stringWithFormat:@"%@%@",subdomainURL,updateProtocolURL];
    NSURL *url = [NSURL URLWithString:urlString];
    NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:url
                                                           cachePolicy:NSURLRequestUseProtocolCachePolicy
                                                       timeoutInterval:60.0];
...
//    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
//    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
//    NSString *urlString=[NSString stringWithFormat:@"%@/%@/%@",savePaperworkRuleURL,ruleID,ruleType];
//    NSURL *url = [NSURL URLWithString:urlString];
//    NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:url
//                                                           cachePolicy:NSURLRequestUseProtocolCachePolicy
//                                                       timeoutInterval:60.0];
...
//    
//    [request setHTTPMethod:@"POST"];
//    NSData *postData = [NSJSONSerialization dataWithJSONObject:declarationMsg options:0 error:&error];
//    [request setHTTPBody:postData];
//    
//    
//    NSURLSessionDataTask *postDataTask = [session dataTaskWithRequest:request completionHandler:^(NSData *data, NSURLResponse *response, NSError *error) {
...
//            NSLog(@"%@",mystring);
//            if ([mystring isEqualToString:@"1"]) {
//                [self listingAllPaperworkRule: ruleType : [[NSUserDefaults standardUserDefaults]objectForKey:@"selectedofficeId"]];
//            }
//            else
//            {
//                if ([self.mydelegate respondsToSelector:@selector(showalerviewcontroller:)]&&(self.mydelegate!=NULL))
//                {
//                    [self.mydelegate showalerviewcontroller:@"Failed to Update Leave Paperwork"];
//                }
//            }
//            
//            
...
//    [postDataTask resume];
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
    NSString *urlString=[NSString stringWithFormat:@"%@%@",subdomainURL,savePaperworkRuleURL];
    NSURL *url = [NSURL URLWithString:urlString];
    NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:url
                                                           cachePolicy:NSURLRequestUseProtocolCachePolicy
                                                       timeoutInterval:60.0];
...
//    NSURLSession *session = [NSURLSession sharedSession];
//    NSString *urlString=[NSString stringWithFormat:@"%@%@/%@/%@/%@",viewIndividualProtocolViewURL,officeID,ruleID,tileID,type];
//    NSURLSessionDataTask *dataTask = [session dataTaskWithURL:[NSURL URLWithString:urlString] completionHandler:^(NSData *data, NSURLResponse *response, NSError *error) {
//        
//        if (data==Nil) {
//            
...
//    [dataTask resume];
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
    NSString *urlString=[NSString stringWithFormat:@"%@%@%@/%@/%@/%@",subdomainURL,viewIndividualProtocolViewURL,officeID,ruleID,tileID,type];
...
{
//    NSURLSession *session = [NSURLSession sharedSession];
//    NSString *urlString=[NSString stringWithFormat:@"%@rule_id=%@&&protocol_id=%@&&rule_type=%@",deletePaperworkProtocolURL,ruleID,tileID,ruleType];
//    NSURLSessionDataTask *dataTask = [session dataTaskWithURL:[NSURL URLWithString:urlString] completionHandler:^(NSData *data, NSURLResponse *response, NSError *error) {
//        
//        if (data==Nil) {
//            
...
//    [dataTask resume];
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
    NSString *urlString=[NSString stringWithFormat:@"%@%@%@/%@/%@",subdomainURL,deletePaperworkProtocolURL,ruleID,tileID,ruleType];
...
//    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
//    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
//    NSString *urlString=[NSString stringWithFormat:@"%@",saveCustomPaperworkURL];
//    NSURL *url = [NSURL URLWithString:urlString];
//    NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:url
//                                                           cachePolicy:NSURLRequestUseProtocolCachePolicy
//                                                       timeoutInterval:60.0];
...
//    
//    [request setHTTPMethod:@"POST"];
//    NSData *postData = [NSJSONSerialization dataWithJSONObject:ruleDict options:0 error:&error];
//    [request setHTTPBody:postData];
//    
//    
//    NSURLSessionDataTask *postDataTask = [session dataTaskWithRequest:request completionHandler:^(NSData *data, NSURLResponse *response, NSError *error) {
...
//            NSLog(@"%@",mystring);
//            if ([[json objectForKey:@"status"]isEqualToString:@"200"]) {
//                [self listingAllPaperworkRule: rule_type : [[NSUserDefaults standardUserDefaults]objectForKey:@"selectedofficeId"]];
//            }
//            else if ([[json objectForKey:@"status"]isEqualToString:@"1"])
//            {
//                if ([self.mydelegate respondsToSelector:@selector(showalerviewcontroller:)]&&(self.mydelegate!=NULL))
...
//                }
//            }
//            else if ([[json objectForKey:@"status"]isEqualToString:@"500"])
//            {
//                if ([self.mydelegate respondsToSelector:@selector(showalerviewcontroller:)]&&(self.mydelegate!=NULL))
//                {
//                    [self.mydelegate showalerviewcontroller:@"Failed to Create Custom Rule"];
//                }
//            }
//        }
//    }];
...
//    [postDataTask resume];
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
    NSString *urlString=[NSString stringWithFormat:@"%@%@",subdomainURL,saveCustomPaperworkURL];
    NSURL *url = [NSURL URLWithString:urlString];
    NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:url
                                                           cachePolicy:NSURLRequestUseProtocolCachePolicy
                                                       timeoutInterval:60.0];
    ...
    NSURLSessionDataTask *postDataTask = [session dataTaskWithRequest:request completionHandler:^(NSData *data, NSURLResponse *response, NSError *error) {
        ...
        else if ([httpResponse statusCode]==501)
        {
            if ([self.mydelegate respondsToSelector:@selector(showalerviewcontroller:)]&&(self.mydelegate!=NULL))
            {
                [self.mydelegate showalerviewcontroller:@"Custom Rule Name/ Abbreviation Already Exists"];
            }
        }
        else if ([httpResponse statusCode]==500)
        {
...
-(void)individualCustomPaperworkRuleView:(NSString *)officeID :(NSString *)ruleID :(NSString *)ruleType
{
    //
//    NSURLSession *session = [NSURLSession sharedSession];
//    NSString *urlString=[NSString stringWithFormat:@"%@%@/%@/%@",viewCustomPaperworkURL,officeID,ruleID,ruleType];
//    NSURLSessionDataTask *dataTask = [session dataTaskWithURL:[NSURL URLWithString:urlString] completionHandler:^(NSData *data, NSURLResponse *response, NSError *error) {
//        
//        if (data==Nil) {
//            
...
//    [dataTask resume];
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
    NSString *urlString=[NSString stringWithFormat:@"%@%@%@/%@/%@",subdomainURL,viewCustomPaperworkURL,officeID,ruleID,ruleType];
...
//    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
//    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
//    NSString *urlString=[NSString stringWithFormat:@"%@",updateCustomPaperworkURL];
//    NSURL *url = [NSURL URLWithString:urlString];
//    NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:url
//                                                           cachePolicy:NSURLRequestUseProtocolCachePolicy
//                                                       timeoutInterval:60.0];
...
//    [postDataTask resume];
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
    NSString *urlString=[NSString stringWithFormat:@"%@%@",subdomainURL,updateCustomPaperworkURL];
    NSURL *url = [NSURL URLWithString:urlString];
    NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:url
                                                           cachePolicy:NSURLRequestUseProtocolCachePolicy
                                                       timeoutInterval:60.0];
...
{
//    NSURLSession *session = [NSURLSession sharedSession];
//    NSString *urlString=[NSString stringWithFormat:@"%@%@",deleteCustomPaperworkRuleURL,ruleID];
//    NSURLSessionDataTask *dataTask = [session dataTaskWithURL:[NSURL URLWithString:urlString] completionHandler:^(NSData *data, NSURLResponse *response, NSError *error) {
//        
//        if (data==Nil) {
//            
...
//    [dataTask resume];
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
    NSString *urlString=[NSString stringWithFormat:@"%@%@%@",subdomainURL,deleteCustomPaperworkRuleURL,ruleID];
...
-(void)addnewDocumentationfolder:(NSMutableDictionary *)dict
{
    ...
    NSURLSessionDataTask *postDataTask = [session dataTaskWithRequest:request completionHandler:^(NSData *data, NSURLResponse *response, NSError *error) {
        ...
        else
        {
            ...
            if ([mystring isEqualToString:@"200[]"]) {
...
-(void)customfolderAddnewdocuments:(NSString *)customfolderid documentsdict:(NSMutableDictionary *)docudictionary
{
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
    NSString *urlString=[NSString stringWithFormat:@"%@%@/%@",customfolderDocumentsaddedUrl,customfolderid,@"C"];
    NSURL *url = [NSURL URLWithString:urlString];
    NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:url
                                                           cachePolicy:NSURLRequestUseProtocolCachePolicy
                                                       timeoutInterval:60.0];
    ...
    NSURLSessionDataTask *postDataTask = [session dataTaskWithRequest:request completionHandler:^(NSData *data, NSURLResponse *response, NSError *error) {
        ...
        else
        {
            ...
            if ([[NSString stringWithFormat:@"%@",[json objectForKey:@"result"]] isEqualToString:@"200"]) {
                
                [self documentationList:[[NSUserDefaults standardUserDefaults] objectForKey:@"selectedofficeId"]];
                
                [self.mydelegate showalerviewcontroller:@"Document Added Successfully"];
...
-(void)MovingCopyfunctionality:(NSMutableArray *)docidArray moveingfolder:(NSString *)folderId correspondingAction:(NSString *)actionstring
{
    ...
    NSData *postData = [NSJSONSerialization dataWithJSONObject:movedict options:0 error:&error];
    [request setHTTPBody:postData];
...
-(void)deletedDocumentsinDocumentationfrontscreen:(NSMutableArray *)deleteddocid
{
    ...
    NSDictionary *mapData = [[NSDictionary alloc] initWithObjectsAndKeys:deleteddocid,@"docid_List",@"delete",@"Action",nil];
    ...
    NSURLSessionDataTask *postDataTask = [session dataTaskWithRequest:request completionHandler:^(NSData *data, NSURLResponse *response, NSError *error) {
        ...
        else
        {
            ...
            if ([[NSString stringWithFormat:@"%@",[json objectForKey:@"result"]] isEqualToString:@"200"]) {
                ...
                [self.mydelegate showalerviewcontroller:@"Documents Deleted Successfully"];
...
-(void)documentRenameprocessingFunctionality:(NSString *)doc_id renameVariable:(NSString *)rename
{
    ...
    NSDictionary *mapData = [[NSDictionary alloc] initWithObjectsAndKeys:doc_id,@"doc_id",rename,@"file_name",@"rename",@"Action",nil];
    ...
    NSURLSessionDataTask *postDataTask = [session dataTaskWithRequest:request completionHandler:^(NSData *data, NSURLResponse *response, NSError *error) {
        ...
        else
        {
            ...
            if ([[NSString stringWithFormat:@"%@",[json objectForKey:@"result"]] isEqualToString:@"200"]) {
                ...
                [self.mydelegate showalerviewcontroller:@"Document Renamed Successfully"];
...
-(void)DocumentPdfviewerdisplay:(NSString *)docid
{
    NSURLSession *session = [NSURLSession sharedSession];
    NSString *urlString=[NSString stringWithFormat:@"%@/%@",deltedMaindocumentFolderdocuments,docid];
    NSURLSessionDataTask *dataTask = [session dataTaskWithURL:[NSURL URLWithString:urlString] completionHandler:^(NSData *data, NSURLResponse *response, NSError *error) {
        ...
        else
        {
            ...
            if ([self.mydelegate respondsToSelector:@selector(pdfviewerdisplaydata:)]&&(self.mydelegate!=NULL))
            {
                
                [self.mydelegate pdfviewerdisplaydata:json];
...
-(void)EmailDocumentationprocess:(NSString *)fromaddress toaddress:(NSString *)toaddress subject:(NSString *)subject composematter:(NSString *)composematter attachedimages:(NSMutableArray *)attachedidArray
{
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
    NSString *urlString=[NSString stringWithFormat:@"%@",sendEmailDocumentationfrontscreen];
    NSURL *url = [NSURL URLWithString:urlString];
    NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:url
                                                           cachePolicy:NSURLRequestUseProtocolCachePolicy
                                                       timeoutInterval:60.0];
    ...
    NSDictionary *mapData = [[NSDictionary alloc] initWithObjectsAndKeys:fromaddress,@"from_address",toaddress,@"to_address",subject,@"subject",composematter,@"message",attachedidArray,@"attachedImages",nil];
    ...
    NSURLSessionDataTask *postDataTask = [session dataTaskWithRequest:request completionHandler:^(NSData *data, NSURLResponse *response, NSError *error) {
        ...
        else
        {
            ...
            if ([self.mydelegate respondsToSelector:@selector(mailidDSendingImagesresponse:)]&&(self.mydelegate!=NULL))
            {
                
                [self.mydelegate mailidDSendingImagesresponse:mystring];
...
{
    NSURLSession *session = [NSURLSession sharedSession];
    NSString *urlString=[NSString stringWithFormat:@"%@/%@/%@/%@",pdfviewerindocumentation,pdfid,docType,FolderId];
    NSURLSessionDataTask *dataTask = [session dataTaskWithURL:[NSURL URLWithString:urlString] completionHandler:^(NSData *data, NSURLResponse *response, NSError *error) {
...
-(void)PrintDocumentsinFrontScreen:(NSMutableArray *)printdocid
{
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
    NSString *urlString=[NSString stringWithFormat:@"%@",printDocumentationinfrontscreen];
    NSURL *url = [NSURL URLWithString:urlString];
    NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:url
                                                           cachePolicy:NSURLRequestUseProtocolCachePolicy
                                                       timeoutInterval:60.0];
    ...
    NSDictionary *mapData = [[NSDictionary alloc] initWithObjectsAndKeys:printdocid,@"print_docids",nil];
    ...
    NSURLSessionDataTask *postDataTask = [session dataTaskWithRequest:request completionHandler:^(NSData *data, NSURLResponse *response, NSError *error) {
        ...
        else
        {
            ...
            if ([self.mydelegate respondsToSelector:@selector(printDataDocumentresponse:)]&&(self.mydelegate!=NULL))
            {
                
                [self.mydelegate printDataDocumentresponse:json];
...
-(void)sizedeterminationFunctionality:(NSMutableDictionary *)Doc_dict
{
    ...
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
    NSString *urlString=[NSString stringWithFormat:@"%@",sizedeterminationdocument];
    NSURL *url = [NSURL URLWithString:urlString];
    NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:url
                                                           cachePolicy:NSURLRequestUseProtocolCachePolicy
                                                       timeoutInterval:60.0];
    ...
    NSMutableArray *sizeSendarray = [[Doc_dict allValues] mutableCopy];
    
    NSDictionary *mapData = [[NSDictionary alloc] initWithObjectsAndKeys:sizeSendarray,@"docsize_list",nil];
    ...
    NSURLSessionDataTask *postDataTask = [session dataTaskWithRequest:request completionHandler:^(NSData *data, NSURLResponse *response, NSError *error) {
        ...
        else
        {
            ...
            if ([self.mydelegate respondsToSelector:@selector(sizedeterminationResponse:)]&&(self.mydelegate!=NULL))
            {
                
                [self.mydelegate sizedeterminationResponse:[json objectForKey:@"result"]];
