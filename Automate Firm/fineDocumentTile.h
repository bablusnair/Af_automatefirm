...
@class fineDocumentTile;
@protocol AccordionViewDelegate <NSObject>
@optional
- (void)accordion:(fineDocumentTile *)accordion didChangeSelection:(NSIndexSet *)selection;
@end

@interface fineDocumentTile : UIView <UIScrollViewDelegate,headerprotocol> {
