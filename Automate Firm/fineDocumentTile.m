...
@implementation fineDocumentTile
...
- (void)touchDown:(id)sender {
    ...
    if (app.warningflag==0) {
        ...
        {
            [[NSNotificationCenter defaultCenter]postNotificationName:@"finePaperworkProtocol" object:nil];
            fineDocumentsViewClass *ob = (fineDocumentsViewClass *)self.superview.superview;
            [ob disable];
...
-(void)addaccordianview
{
    ...
    if (selectedIndexValue==flag-2) {
        ...
        NSArray *array=[[NSBundle mainBundle]loadNibNamed:@"fineDocumentInnerView" owner:self options:nil];
    ...
    UIAlertAction* ok = [UIAlertAction actionWithTitle:@"Delete" style:UIAlertActionStyleDefault
                                               handler:^(UIAlertAction * action){
                                                   ...
                                                   if (!([[myappde.conditionIDArray objectAtIndex:mytag]isEqualToString:@"0"])) {
                                                       [self.myconnection deletePaperworkProtocol:myappde.ruleID :[myappde.conditionIDArray objectAtIndex:mytag] :@"fine"];
                                                   }
